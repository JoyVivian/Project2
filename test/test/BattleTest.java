...
public class BattleTest {
  ...
  public void setUp() throws Exception {
    ...
    player1 = new Player("Bang Liu");
    player2 = new Player("Yu Xiang");
    players.add(player1);
    players.add(player2);
  ...
  public void fight() {
    ...
    assertEquals("Player Bang Liu attack Player Yu Xiang and the damage is:16\n" +
            "Player Yu Xiang attack Player Bang Liu and the damage is:16\n" +
            "Player Yu Xiang is the winner.\n", battle.fight("FalseRandom"));
  }
}