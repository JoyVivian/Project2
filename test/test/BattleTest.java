...
public class BattleTest {
  ...
  public void assignGears() {
    String gearsInfo = "Gears for Player1: \n" +
            ...
            + " name='alcohol', affectedAttrs=[90, 0, 0, 0]}\n"
            + ", Gear{Type = class battle.euipments.Potion, "
            ...
            "BeltSize = MEDIUM\n" +
            ", Gear{Type = class battle.euipments.Belt," +
            " name='lovely belt', affectedAttrs=[50, 0, 1, 0]}\n" +
            "BeltSize = SMALL\n" +
            ", Gear{Type = class battle.euipments.Belt, " +
            ...
            ", Gear{Type = class battle.euipments.Potion, " +
            "name='medium dexterity medicine', affectedAttrs=[-30, 0, 3, 0]}\n" +
            ", Gear{Type = class battle.euipments.Potion," +
            " name='painKiller', affectedAttrs=[70, 0, 0, 0]}\n" +
            ", Gear{Type = class battle.euipments.Potion, " +
            "name='small charming medicine', affectedAttrs=[28, 0, 0, 0]}\n" +
            ", Gear{Type = class battle.euipments.Potion," +
            ...
            "BeltSize = LARGE\n" +
            ", Gear{Type = class battle.euipments.Belt, " +
            "name='poor belt', affectedAttrs=[19, -1, 0, -2]}\n" +
            "BeltSize = LARGE\n" +
            ", Gear{Type = class battle.euipments.Belt," +
